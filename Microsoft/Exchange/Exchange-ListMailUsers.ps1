...
<#
  ...
  ===========================================================================
   ...
   Filename:     	Exchange-ListMailUsers.ps1
   Instructions:    
  ===========================================================================
  ...
  .EXAMPLE
    Exchange-ListMailUsers.ps1.ps1 
#>
...
}) | Select RecipientType,FirstName,LastName,DisplayName,TotalItemSize,ItemCount,TotalDeletedItemSize,DeletedItemCount,Servername,Database,PrimarySmtpAddress,Alias,@{Name=“EmailAddresses”;Expression={$_.EmailAddresses | Where-Object {$_.PrefixString -ceq “smtp”} | ForEach-Object {$_.SmtpAddress}}} | Export-CSV .\Exchange-ListMailUsers.csv -Encoding UTF8 -NoTypeInformation